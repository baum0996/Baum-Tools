...
- Windows System Info Dashboard
- Folder and ZIP archive analysis
- Read-only Windows startup entry inspection
- Read-only OS, hardware, storage, Python, and network overview
...
- Windows tools
- Startup Analyzer report export
- System Info Dashboard export
- Network tools
- File tools
- General utilities
- Hash generator
